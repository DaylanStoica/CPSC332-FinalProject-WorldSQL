...
CREATE TABLE CountryEducation (
  ...
  Money FLOAT(8,2) NOT NULL DEFAULT '0.0',
...
CREATE TABLE CountryDebt (
  CountryCode CHAR(3) NOT NULL DEFAULT '',
  DebtTotal BIGINT(25) NOT NULL DEFAULT '0',
  DebtUSD BIGINT(25) NOT NULL DEFAULT '0',
  DebtRatio FLOAT(5,2) NOT NULL DEFAULT '0.0',
...
INSERT INTO CountryDebt VALUES ('PRT',232000000000,264000000000,117.00,'Euro');
INSERT INTO CountryDebt VALUES ('ITA',2170000000000,2480000000000,135.00,'Euro');
INSERT INTO CountryDebt VALUES ('BTN',2330000000,2330000000,110.00,'Ngultrum');
INSERT INTO CountryDebt VALUES ('CYP',18950000000,21640000000,95.50,'Euro');
INSERT INTO CountryDebt VALUES ('BEL',399500000000,456180000000,98.60,'Euro');
INSERT INTO CountryDebt VALUES ('USA',19230000000000,19230000000000,107.00,'US Dollar');
INSERT INTO CountryDebt VALUES ('ESP',1090000000000,1240000000000,95.50,'Euro');
INSERT INTO CountryDebt VALUES ('SGP',350000000000,254000000000,126.00,'Singapore Dollar');
COMMIT;
