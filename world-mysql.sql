...
DROP TABLE IF EXISTS CountryDebt;
CREATE TABLE CountryDebt (
  CountryCode CHAR(3) NOT NULL DEFAULT '',
  DebtTotal INT(15) NOT NULL DEFAULT '',
  DebtUSD INT(15) NOT NULL DEFAULT '',
  DebtRatio FLOAT(5) NOT NULL DEFAULT '',
  CurrencyType CHAR(45) NOT NULL DEFAULT '',
  PRIMARY KEY (CountryCode, DebtTotal)
  FOREIGN KEY (CountryCode) REFERENCES Country(Code)
);
START TRANSACTION;
INSERT INTO CountryDebt VALUES ('JAP',1028000000000,9087000000000,2.37,'Yen');
INSERT INTO CountryDebt VALUES ('GRC',332600000000,379000000000,1.77,'Euro');
INSERT INTO CountryDebt VALUES ('PRT',232000000000,264000000000,1.17,'Euro');
INSERT INTO CountryDebt VALUES ('ITA',2170000000000,2480000000000,1.35,'Euro');
INSERT INTO CountryDebt VALUES ('BTN',2330000000,2330000000,1.10,'Ngultrum');
INSERT INTO CountryDebt VALUES ('CYP',18950000000,21640000000,0.9550,'Euro');
INSERT INTO CountryDebt VALUES ('BEL',399500000000,456180000000,0.9860,'Euro');
INSERT INTO CountryDebt VALUES ('USA',19230000000000,19230000000000,1.07,'US Dollar');
INSERT INTO CountryDebt VALUES ('ESP',1090000000000,1240000000000,0.9550,'Euro');
INSERT INTO CountryDebt VALUES ('SGP',350000000000,254000000000,1.26,'Singapore Dollar');
COMMIT;
